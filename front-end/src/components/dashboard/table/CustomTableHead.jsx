...
import { Box, TableCell, TableHead, TableRow, TableSortLabel, Checkbox, tableCellClasses, tableRowClasses, tableSortLabelClasses, Button } from '@mui/material';
...
export default function CustomTableHead({ headCells, onSelectAllClick, sortDir, sortBy, numSelected, onRequestSort, selectedAll, onSubmitDelete }) {
    const createSortHandler = (property) => (e) => { onRequestSort(e, property) };
    const handleSubmitDelete = () => { if (onSubmitDelete) onSubmitDelete() };
