...
const ProductTag = styled.span`
    ...
    background-color: ${props => props.theme.palette[props.color]?.light || props.theme.palette.info.light};
    color: ${props => props.theme.palette[props.color]?.dark || props.theme.palette.info.dark};
    font-size: 12px;
    font-weight: 500px;
    z-index: 1;
`
