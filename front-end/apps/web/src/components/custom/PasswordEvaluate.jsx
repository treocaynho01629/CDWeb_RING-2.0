...
const Indicator = styled.span`
    ...
    &.empty {
        ...
        outline: .5px solid ${props => props.theme.palette.divider};
    }
`
...
const PasswordEvaluate = ({ password, onValid }) => {
    ...
    return (
        <Box mt={-1} sx={{ color: `${customEvaluate[strength].color}.main` }}>
            ...
            <EvaluateHelperText>Độ dài mật khẩu từ 8-24 kí tự bao gồm cả chữ cái thường và chữ số.</EvaluateHelperText>
        </Box>
    )
}
