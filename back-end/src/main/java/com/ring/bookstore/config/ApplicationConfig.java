...
public class ApplicationConfig {
     ...
     * <p>
     * This bean is used by Spring Security to authenticate users via their username.
     * </p>
     *
     * @return A {@link UserDetailsService} that fetches users from the {@link AccountRepository}.
     */
    @Bean
    ...
    /**
     * Provides the authentication manager bean that Spring Security uses to authenticate credentials.
     *
