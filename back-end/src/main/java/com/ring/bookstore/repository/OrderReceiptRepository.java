...
public interface OrderReceiptRepository extends JpaRepository<OrderReceipt, Long>{
	...
	@Query("""
	select month(o.orderDate) as name, coalesce(sum(o2.amount) , 0) as books, coalesce(sum(distinct o.total) , 0) as sales 
