package com.ring.config.auditor;
...
/**
 * Implementation of {@link AuditorAware} to provide the current auditor
 * (e.g., @CreatedDate, @LastModifiedDate).
 */
public class Auditor implements AuditorAware<String> {
     ...
     *
     * @return An {@link Optional} containing the username of the currently
     *         authenticated user,
